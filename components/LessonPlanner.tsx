            ...
            <div className="p-6">
                ...
                {isOnline && (
                    <div className="mt-4">
                        ...
                        <div className="p-2 bg-gray-50 rounded-md min-h-[40px] flex flex-wrap gap-2 items-center">
                            ...
                            {suggestedTopics.map((suggestion, index) => (
                                <button key={index} onClick={() => setTopic(suggestion)} className="text-sm bg-indigo-100 text-indigo-700 px-3 py-1 rounded-full hover:bg-indigo-200">
                                    {suggestion}
                                </button>
                            ))}
                        </div>
