                ...
                <div className="rounded-2xl border border-gray-200 bg-white px-5 py-4 shadow-sm">
                    ...
                    <dl className="mt-4 grid grid-cols-1 gap-y-3 text-sm text-gray-700">
                        ...
                        <div className="flex items-baseline justify-between gap-3">
                            ...
                            <dd className="text-base font-semibold text-gray-900">{Math.round(performance.totalScore || 0)}</dd>
                        </div>
                        <div className="flex items-baseline justify-between gap-3">
                        ...
                        <div className="flex items-baseline justify-between gap-3">
                            <dt className="text-gray-500">Subjects Offered</dt>
                        ...
                        <table className="min-w-full divide-y divide-gray-200 text-sm text-gray-700">
                            <thead className="bg-indigo-600 text-xs font-semibold uppercase tracking-[0.2em] text-white print:bg-gray-200 print:text-gray-800">
                                <tr>
                                    ...
                                    <th className="px-4 py-3 text-center">CA1 ({maxCa1})</th>
                                    <th className="px-4 py-3 text-center">CA2 ({maxCa2})</th>
                                    <th className="px-4 py-3 text-center">Exam ({maxExam})</th>
                            ...
                            <tbody className="bg-white">
                                {results.map(res => (
                                    <tr key={res.subjectName} className="odd:bg-white even:bg-indigo-50/40 print:bg-transparent">
                                        ...
                                        <td className="px-4 py-3 text-center border-b border-gray-100">{res.ca1 ?? '-'}</td>
                                        <td className="px-4 py-3 text-center border-b border-gray-100">{res.ca2 ?? '-'}</td>
                                        <td className="px-4 py-3 text-center border-b border-gray-100">{res.exam ?? '-'}</td>
