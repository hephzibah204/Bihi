...
const Hero = ({ content }: { content: LandingPageContent['hero'] }) => (
    <section className="py-24 text-center bg-gray-50">
        <div className="container mx-auto px-6">
            <h1 className="text-4xl md:text-6xl font-extrabold text-gray-900 leading-tight" dangerouslySetInnerHTML={{ __html: content?.title || '' }} />
            <p className="mt-4 max-w-2xl mx-auto text-lg md:text-xl text-gray-600" dangerouslySetInnerHTML={{ __html: content?.subtitle || '' }} />
