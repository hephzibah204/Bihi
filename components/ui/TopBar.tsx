  ...
  return (
    <header className="h-16 bg-white border-b border-gray-200 flex items-center justify-between px-6">
      ...
      <div className="flex items-center gap-3">
        ...
        <IconBtn title="Messages" onClick={() => navigateView(ADMIN_VIEWS.COMMUNICATIONS)}><ChatBubbleLeftRightIcon className="w-5 h-5" /></IconBtn>
        ...
        <div className="relative flex items-center gap-2 ml-2">
          ...
          {menuOpen && (
            <div className="absolute right-0 top-10 bg-white border border-gray-200 rounded-xl shadow p-2 w-40">
              <button className="w-full text-left px-3 py-2 rounded hover:bg-gray-50 text-sm" onClick={() => { navigateView(ADMIN_VIEWS.ADMIN_PROFILE); setMenuOpen(false); }}>Profile</button>
