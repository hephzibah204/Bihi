        ...
        <div className="card">
            <div className="p-6">
                ...
                <div className="mt-4 space-y-4">
                    <div>
                        <label className="label" htmlFor="announcement-topic">Announcement Topic</label>
                        <input
                    ...
                    <div>
                        ...
                        <select id="tone-select" className="input-field" value={tone} onChange={(e) => setTone(e.target.value)}>
                ...
                {generatedMessage && (
                    <div className="mt-6 border-t pt-4">
                        <label className="label" htmlFor="generated-message">Generated Message</label>
                        <textarea
